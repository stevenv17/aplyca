...
class getSecurity_Authentication_Provider_Guard_MainService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        }, 1), ($container->privates['security.user.provider.concrete.user_provider'] ?? $container->load('getSecurity_User_Provider_Concrete_UserProviderService')), 'main', new \Symfony\Component\Security\Core\User\UserChecker(), ($container->services['security.password_encoder'] ?? $container->load('getSecurity_PasswordEncoderService')));
    }
}
